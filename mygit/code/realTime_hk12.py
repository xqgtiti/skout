...
SESSIONID_hk = \
    ['62e736ff-456b-4c05-8911-a6e3e847b5ce',
     '7f528b1e-2d69-4f40-94bc-370f2249b0df',
     '42be191d-d172-4a3e-b7bb-c9a405a61f8b']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk12.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 55000 AND id <= 60000")
