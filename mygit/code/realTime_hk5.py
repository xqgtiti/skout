...
SESSIONID_hk = \
    ['a311260d-9a78-4b4e-9b43-71d48f21bf0f',
     '0e69c778-ad53-418c-b3c0-7734c11c7e54',
     'eae870b9-1a86-4d84-8ed8-1560c71ef225']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk5.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 20000 AND id <= 25000")
