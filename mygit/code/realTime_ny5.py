...
SESSIONID_ny = \
    ['914aecf5-6c0c-43b1-811e-00b493a2bf68',
     'ab68065c-c634-4298-a024-32e87010f089',
     '1d6f0932-c66a-4c82-936c-b0871b156c9d']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_ny5.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo where id > 20000 AND id <= 25000")
