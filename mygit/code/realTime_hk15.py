...
SESSIONID_hk = \
    ['0018e207-0ee7-4046-bb50-281db314b749',
     '06a73b4d-488f-4760-afa2-84ba1043df07',
     '757b1ab4-391e-432f-a59f-ae9afb39e07a']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk15.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 70000 AND id <= 75000")
