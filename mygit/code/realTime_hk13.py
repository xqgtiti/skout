...
SESSIONID_hk = \
    ['95655967-4971-4979-a4bb-7c6dc886dd28',
     '04bc693e-50a4-46a1-823f-7bbc9751b593',
     '1ec1db66-9be1-43be-96cd-0e15ffa1f65e']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk13.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 60000 AND id <= 65000")
