...
SESSIONID_hk = \
    ['b5d59eec-b0da-4f82-9f94-50c3c1d76fd6',
     'deaa7712-65a1-44fe-8529-877762cc4087',
     'a125438a-0921-489f-b379-19342703279e']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk4.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 15000 AND id <= 20000")
