...
SESSIONID_ny = \
    ['33c88ba8-5a35-4d4d-9af2-509e3563809d',
     '64632e85-255e-463c-9a76-99fc9c4136bf',
     '98dacc68-72e8-4b79-a6ea-a02c15d09271']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_ny3.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo where id > 10000 AND id <= 15000")
