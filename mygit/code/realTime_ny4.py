...
SESSIONID_ny = \
    ['3f149a38-6701-482a-9ce3-b69d08478e7a',
     '3422214f-90bd-4f3c-b1f3-be050fcf2d3d',
     '59aed8b2-8a7b-4d3d-a39e-276bdabe0140']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_ny4.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo where id > 15000 AND id <= 20000")
