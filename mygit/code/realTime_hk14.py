...
SESSIONID_hk = \
    ['7bf5d735-0cfd-4c5a-8991-a1d72b9c7e18',
     'c2424021-93e4-488e-bc47-0fadff40395a',
     'bc5a361b-4570-4a94-b17e-6fb062383214']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk14.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 65000 AND id <= 70000")
