...
SESSIONID_ny = \
    ['ef741d2f-e165-4c03-9bc4-041feefaf14d',
     '09465170-e4b2-44fe-9882-c2feab597651',
     '6f99c8e3-8f13-4bf9-9a3f-2e8d5f692863']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_ny6.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo where id > 25000 AND id <= 30000")
