...
SESSIONID_hk = \
    ['b1a41376-78a0-4d42-b978-86072f3b75ca',
     '45b000f2-2fef-4dca-b6ab-9c775d700e2e',
     'ae9a886e-6f5a-442b-b96d-b327208ae110']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk6.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 25000 AND id <= 30000")
