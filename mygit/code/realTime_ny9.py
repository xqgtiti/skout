...
SESSIONID_ny = \
    ['690a59ca-a40f-4ab8-a54b-4867aa890b81',
     'd1264aa4-d8b1-4ca8-acd2-a265f581d038',
     '0c5b3ef3-f5b2-4a5c-8451-0ee6a31540ef']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_ny9.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo where id > 40000 AND id <= 45000")
