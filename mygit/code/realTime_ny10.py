...
SESSIONID_ny = \
    ['da1cdc4d-31af-4619-abf5-ab64b0283df6',
     '7da76bb3-b05a-45f3-98d7-a2dec7465285',
     'fe56a6fc-1f0f-417b-add9-2ed04c0bbcf9']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_ny10.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo where id > 45000 AND id <= 50000")
