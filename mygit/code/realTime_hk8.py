...
SESSIONID_hk = \
    ['e007833b-d8bd-4cd7-bf4e-fc2c51ab7c8f',
     'b13e259a-6505-4bd5-8305-f11f59cac9c2',
     'd79ad52f-3390-47b0-97ab-cd314c281518']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk8.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 35000 AND id <= 40000")
