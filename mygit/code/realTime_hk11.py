...
SESSIONID_hk = \
    ['161aacf5-e276-4bae-a2f0-923aa414ab1e',
     '930aca45-118f-44a9-934f-8e28973091a6',
     '849a47c9-d209-4e73-981e-73d31bee8e6b']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk11.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 50000 AND id <= 55000")
