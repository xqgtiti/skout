...
SESSIONID_ny = \
    ['1248bbec-9e18-4d63-96f9-db40aebc0c34',
     '3ec7a22d-13d8-4a4f-b81d-2df9cd83b273',
     'a2199e96-a2a1-4f14-a9ff-e9dde224de53']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_ny2.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo where id > 5000 AND id <= 10000")
