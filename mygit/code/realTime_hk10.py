...
SESSIONID_hk = \
    ['d77ea019-c34d-48a7-b57d-1b5a252a231a',
     '350353c1-5156-4bcc-b337-7620783fdba0',
     '509d5769-e84c-4f17-a74f-fd261a71e40a']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk10.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 45000 AND id <= 50000")
