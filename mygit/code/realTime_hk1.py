...
SESSIONID_hk = \
    ['03cc3d11-a2ac-45b2-8453-bf7667910142',
     '3f10858c-b6ea-4622-b497-51b7d071733e',
     '10343746-380b-40e9-9727-f0135ef5caa8']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk1.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id <= 5000")
