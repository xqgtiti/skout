...
SESSIONID_hk = \
    ['673f09f8-a1b6-4476-9660-de6085d93519',
     '703c8f2b-e5ba-4436-af66-53281f283c99',
     '9956e055-2bdc-475d-8854-19e6d6c30a73']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk16.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 75000 AND id <= 80000")
