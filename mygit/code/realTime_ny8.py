...
SESSIONID_ny = \
    ['c9c802a3-ffc4-436a-bc71-24b682be08c4',
     '5fd67ce8-910e-4c4d-ba4e-2036341d532e',
     '5fd67ce8-910e-4c4d-ba4e-2036341d532e']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_ny8.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo where id > 35000 AND id <= 40000")
