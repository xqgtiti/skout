...
SESSIONID_hk = \
    ['0bb40d4d-5f50-44a2-80f2-e306009387c6',
     '50b92477-87ab-47d3-8300-8b15094d7b72',
     '69557417-e6a8-4a95-a8ba-5616742a1e9c']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk2.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 5000 AND id <= 10000")
