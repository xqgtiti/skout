...
SESSIONID_ny = \
    ['5882e5c8-e7fb-4030-a449-f16255743564',
     '7e2d2b88-d4ce-4874-bc1b-3dec04f21983',
     '33dfbc13-a829-4eac-99d1-0ee0287ea6e5']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_ny7.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo where id > 30000 AND id <= 35000")
