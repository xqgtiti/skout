...
SESSIONID_hk = \
    ['7b8548b4-5002-443c-b40e-3369ed0ab676',
     '017060bb-1901-42ce-87c5-4f372fae4d8e',
     '0a741376-3d6e-45dc-a469-5bcbcc5370e4']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk9.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 40000 AND id <= 45000")
