...
SESSIONID_hk = \
    ['9f9be981-eb25-47b7-955d-51d1ae63f8ed',
     'a410f7e5-1539-411b-bba9-4d26e8ceba0f',
     '158aab6b-6fe8-4bdf-aa3c-2787dddcf52b']
#香港 经纬度
...
handler = logging.handlers.RotatingFileHandler('/home/tst_hk3.txt', maxBytes=1024*1024*1024*1024,backupCount = 10) # 实例化handler
...
if __name__ == '__main__':
    ...
    cur.execute("SELECT user_id from userinfo_hk where id > 10000 AND id <= 15000")
